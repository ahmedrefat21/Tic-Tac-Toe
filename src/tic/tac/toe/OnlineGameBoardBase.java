...
public  class OnlineGameBoardBase extends AnchorPane {
    ...
    public OnlineGameBoardBase(Stage stage) {
        ...
        AnchorPane.setBottomAnchor(exitButton, 28.0);
        AnchorPane.setLeftAnchor(exitButton, 661.0);
        AnchorPane.setRightAnchor(exitButton, 50.0);
        AnchorPane.setTopAnchor(exitButton, 421.0);
        exitButton.setLayoutX(661.0);
        exitButton.setLayoutY(421.0);
        exitButton.setMnemonicParsing(false);
        exitButton.setPrefHeight(31.0);
        exitButton.setPrefWidth(29.0);
